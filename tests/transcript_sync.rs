...
use zkp::{toolbox::TranscriptProtocol, BatchableProof, CompactProof, Transcript};
...
fn create_and_verify_compact() {
    ...
    let smth4 =
        <Transcript as TranscriptProtocol<G1Affine>>::get_challenge(&mut transcript2, b"DLEQTest");
    assert_eq!(smth3, smth4);
    assert_ne!(smth1, smth3);
    assert_ne!(smth2, smth4);
}
